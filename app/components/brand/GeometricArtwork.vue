...
<template>
  <div class="relative w-full aspect-4/5 max-w-xl mx-auto select-none overflow-hidden" :class="props.class" aria-hidden="true">
    <!-- NOTE - ANCHOR: Bauhaus paper-cut decorative artwork -->
    ...
    <div class="absolute top-[28%] left-[14%] w-[32%] h-[28%] border border-terracotta/30 bg-terracotta/6 dark:bg-terracotta/10 rotate-6" />
