    ...
    <template #default>
      <div class="py-24 sm:py-32">
        <div class="grid lg:grid-cols-12 gap-14 lg:gap-16 items-center">
              ...
              >
                <div class="flex items-center gap-4">
                  ...
                  <div class="min-w-0">
                    ...
                    <p class="text-sm text-flow-muted dark:text-flow-muted-dark truncate">
                      {{ item.hint }}
                    </p>
                  </div>
                  <UIcon
          ...
          <div class="lg:col-span-7 landing-section-panel">
            <div class="landing-demo-frame">
              <div class="landing-demo-chrome">
                ...
                <span class="landing-demo-space-badge shrink-0">
                  ...
                  <span class="truncate max-w-[7rem]">{{ scene.title }}</span>
                </span>
              </div>
              ...
              <div class="landing-demo-shell">
                ...
                <Transition name="landing-scene" mode="out-in">
                  <div :key="scene.type" class="landing-demo-body landing-demo-body-app">
            ...
            <p class="mt-4 text-center text-xs text-flow-muted dark:text-flow-muted-dark">
