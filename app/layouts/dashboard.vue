  ...
  <ClientOnly>
    <div class="flex h-dvh overflow-hidden bg-default text-default">
      ...
      >
        ...
        <div
          v-if="!isMinor"
          class="border-b border-default px-4 py-4"
        >
        ...
        <header class="flex items-center justify-between gap-2 border-b border-default px-3 py-2.5 sm:px-4 lg:hidden">
          <div class="flex min-w-0 flex-1 items-center gap-2">
            ...
            <ClientOnly>
              ...
              <template #fallback>
                <span
                  class="h-9 min-w-24 flex-1 rounded-lg bg-elevated/40"
                  aria-hidden="true"
                />
              </template>
            </ClientOnly>
        ...
        <header class="dashboard-header-bar hidden h-18 shrink-0 items-center justify-between gap-4 border-b border-default px-6 lg:flex lg:px-8">
          ...
          <div class="flex items-center gap-2">
            ...
            <ClientOnly>
              ...
              <template #fallback>
                <span
                  class="inline-block h-6 w-14 rounded-md bg-elevated/50"
                  aria-hidden="true"
                />
              </template>
            </ClientOnly>
    ...
    <template #fallback>
      <div
        class="flex h-dvh overflow-hidden bg-default text-default"
        aria-busy="true"
      >
        <div class="flex min-w-0 flex-1 flex-col overflow-hidden">
